...
template<> TEMPESTCOMBATFRAMEWORK_API UScriptStruct* StaticStruct<FAttributeModifierProperties>()
{
	...
	struct Z_CompiledInDeferFile_FID_Git_OL_OLVS_OpusLoriDemoVS_Plugins_TempestCombatFramework_Source_TempestCombatFramework_Public_Objects_TempestBaseAttributeModifier_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_OL_OLVS_OpusLoriDemoVS_Plugins_TempestCombatFramework_Source_TempestCombatFramework_Public_Objects_TempestBaseAttributeModifier_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_OL_OLVS_OpusLoriDemoVS_Plugins_TempestCombatFramework_Source_TempestCombatFramework_Public_Objects_TempestBaseAttributeModifier_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_OL_OLVS_OpusLoriDemoVS_Plugins_TempestCombatFramework_Source_TempestCombatFramework_Public_Objects_TempestBaseAttributeModifier_h_2512977482(TEXT("/Script/TempestCombatFramework"),
		Z_CompiledInDeferFile_FID_Git_OL_OLVS_OpusLoriDemoVS_Plugins_TempestCombatFramework_Source_TempestCombatFramework_Public_Objects_TempestBaseAttributeModifier_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Git_OL_OLVS_OpusLoriDemoVS_Plugins_TempestCombatFramework_Source_TempestCombatFramework_Public_Objects_TempestBaseAttributeModifier_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Git_OL_OLVS_OpusLoriDemoVS_Plugins_TempestCombatFramework_Source_TempestCombatFramework_Public_Objects_TempestBaseAttributeModifier_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Git_OL_OLVS_OpusLoriDemoVS_Plugins_TempestCombatFramework_Source_TempestCombatFramework_Public_Objects_TempestBaseAttributeModifier_h_Statics::ScriptStructInfo),
		nullptr, 0);
